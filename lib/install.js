...
function install(fn){
   ...
   *
   * TODO: pretty sure we might be able to eliminate the nested Ware need by
   * just using local variables for this top-level stuff here which would be
   * nicer i think, instead of having this magic `tree` object
   *
   * @param {Object} tree
   * @param {Function} done
   */
