...
/**
 * Get any components that have already been installed to the component's
 * install destination folder, and callback `fn(err, components)`.
 *
 * @param {Function} fn
 */

Component.prototype.getComponents = function(fn){
  var components = [];
 ...
 *
 * NOTE: The logic is in another file for clarity, since it's complex by nature.
 *
 * @param {Function} fn
 */
