...
/**
 * Get or register a `remote`.
 *
 * @param {Remote} remote
 * @return {Remote or Component}
 */

Component.prototype.remote = function(remote){
  if ('string' == typeof remote) {
    if (this.remotes[remote]) return this.remotes[remote];
    var err = new Error('Could not find a "' + remote + '" remote.');
